...
from mapfishapp.model.cyclerouting2 import Routing2
...
class Cyclerouting2Controller(BaseController):
    readonly = False # if set to True, only GET is supported

    def __init__(self):
        self.protocol = Protocol(Session, Routing2, self.readonly)
    ...
    def index(self, format='json'):
        ...
        #
        # default_filter = create_default_filter(request, Routing2)
        # filter = and_(default_filter, Routing2.columname.ilike('%value%'))
