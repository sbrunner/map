...
from mapfishapp.model.couting import Routing
...
class CoutingController(BaseController):
    readonly = False # if set to True, only GET is supported

    def __init__(self):
        self.protocol = Protocol(Session, Routing, self.readonly)
    ...
    def index(self, format='json'):
        ...
        #
        # default_filter = create_default_filter(request, Routing)
        # filter = and_(default_filter, Routing.columname.ilike('%value%'))
