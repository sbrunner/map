...
OpenLayers.Format.URLCompressed = OpenLayers.Class(OpenLayers.Format, {
    ...
    parseGeometry: function(data) {
        ...
        switch (data.charAt(0)) {
            ...
            case 'a':
                ...
                for (var i=0, len=ringsData.length; i<len; ++i) {
    ...
    extractAttributes: function(attributes) {
        var result = "";
    ...
    extract: {
        ...
        'feature': function(feature) {
            ...
            if (feature.attributes && !isEmpty(feature.attributes)) {
                return geom.substring(0, geom.length - 1) + '~' + this.extractAttributes(feature.attributes) + ")";
            }
            else {
                return geom;
            }
